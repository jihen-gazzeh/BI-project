...
def process_outlier(tmp, column_name, threshold=1.5):
...
rows, cols = df.shape
articles = df.articleid.unique().shape[0]

print(f'Dataset Shape\n\nNumber of rows : {rows}\nNumber of columns: {cols}\nNumber of different types of articles : {articles}')
...
load_data_to_postgres(filtered_data, 'Stocks', 'postgresql://postgres:0000@127.0.0.1:5432/ETL')
